...
public class Capybara extends Animal implements AnimatedEntity {
    public static final ResourceLocation ID = Util.id("capybara");
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        if (tag.contains("Apple")) this.apple = ItemStack.of(tag.getCompound("Apple"));
    ...
    public void addAdditionalSaveData(CompoundTag tag) {
        ...
        if (!this.apple.isEmpty())
            tag.put("Apple", this.apple.save(new CompoundTag()));
    }
